...
2.  *Make some data analysis for further data visualization.* Let's add another column and calculate what is the total change in population % of prescribed medication during 2010 - 2021. We will also arrange the data in ascending order.
